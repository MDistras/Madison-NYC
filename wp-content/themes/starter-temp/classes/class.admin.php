...
if (!class_exists('WordsearchAdmin', false)) {
    ...
    class WordsearchAdmin
    {
        ...
        public function kns_run_frontend_scripts()
        {
            ...
            wp_enqueue_script('svg-inline-js', 'https://cdn.jsdelivr.net/gh/jonnyhaynes/inline-svg@2.2.1/dist/inlineSVG.min.js', null, true);
            ...
            wp_enqueue_script('waypoint-cdn-js', 'https://cdnjs.cloudflare.com/ajax/libs/waypoints/4.0.1/jquery.waypoints.min.js', array('jquery'), null, true);
            ...
            // Main theme script
            wp_enqueue_script('custom-js', get_stylesheet_directory_uri() . '/js/custom.js', array('jquery', 'svg-inline-js'), null, true);
            wp_localize_script(
                'custom-js',
                'ajax_object',
